            ...
            <div class="container">
                ...
                <nav class="nav footer-nav">
                    <ul class="nav__list footer-nav__list">
                        <li class="nav__item footer-nav__item"><a href="#" class="footer-nav__link"> Контакты данные</a></li>
                        <li class="nav__item footer-nav__item"><a href="#" class="footer-nav__link"> Требования к макетам</a></li>
                        <li class="nav__item footer-nav__item"><a href="#" class="footer-nav__link"> Акции</a></li>
                        <li class="nav__item footer-nav__item"><a href="#" class="footer-nav__link"> О компании</a></li>
                        <li class="nav__item footer-nav__item"><a href="#" class="footer-nav__link"> Разработка дизайна</a></li>
                        <li class="nav__item footer-nav__item"><a href="#" class="footer-nav__link"> Вопрос / ответ</a></li>
                        <li class="nav__item footer-nav__item"> <a href="#" class="footer-nav__link">Услуги</a></li>
                        <li class="nav__item footer-nav__item"> <a href="#" class="footer-nav__link">Доставка и оплата</a></li>
                        
                    </ul>
                </nav>
                <ul class="footer-info__list">
                    <li class="footer-info__item">г. Симферополь, ул. Чехова, 2    </li>
                    <li class="footer-info__item">понедельник - пятница 9:00 - 18:00  </li>
                    <li class="footer-info__item"><a href="mailto:zakaz@wowmedia.pro" class="footer-info__link">zakaz@wowmedia.pro</a></li>
                </ul>
                <ul class="download__list">
                    <li class="download__item"><a href="#" download="" class="download__link" >Политика обработки
                        персональных данных</a></li>
                    <li class="download__item"><a href="#" download="" class="download__link">Договор оферты</a></li>
                </ul>
                <p class="text footer-company">© 2021  «Вау Медиа». Все права защищены</p>
                <div class="footer_social">
                    <a href="" class="footer__social_item footer__social_insta"></a>
                    <a href="" class="footer__social_item footer__social_facebook"></a>
                </div>
                </div>
        ...
        <div class="cookie">
            <div class="container">
                <div class="cookie__content">
                    <p class="cookie__text">Продолжая просмотр сайта, вы соглашаетесь на использование файлов 
                        cookie в соответствии с Информацией об использовании файлов cookie 
                        и принимаете условия Соглашения об использовании сайта.
                    </p>
                    <button class="button cookie__button">СОГЛАСИТЬСЯ</button>  
                </div>
            </div>
        </div>
        <?php  wp_footer(  )?>
